...
class TheatreController extends Controller
{
    ...
    public function store(CreateRequest $request)
    {
        ...
        if ($theatre) {
            return redirect()->route('admin.theatre.index')->with('message', 'Theatre has been added successfully');;
        }
        return redirect()->route('admin.theatre.index')->with('message', 'Something went wrong');
    }
    ...
    public function update(UpdateRequest $request, Theatre $theatre)
    {
        ...
        if ($updatedTheatre) {
            return redirect()->route('admin.theatre.index')->with('message', 'Theatre has been edited successfully');
        }
        return redirect()->route('admin.theatre.index')->with('message', 'Something went wrong');
    }
    ...
    public function destroy(Theatre $theatre)
    {
        if ($theatre->forceDelete()) {
            ...
            return redirect()->route('admin.theatre.index')->with('message', 'Theatre has been deleted successfully');
        }
        return redirect()->route('admin.theatre.index')->with('message', 'Something went wrong');
    }
}
